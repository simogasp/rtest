#ifndef _CHESSBOARDCAMERATRACKERKLT_HPP_
#define	_CHESSBOARDCAMERATRACKERKLT_HPP_
...
public:
	...
	*/
	bool process( cv::Mat &input, cv::Mat &pose, const OcvCamera & cam, const cv::Size &boardSize, const Pattern &patt  );
...
#endif /*_CHESSBOARDCAMERATRACKERKLT_HPP_*/
