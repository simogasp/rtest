...
if (ARTOOLKITPLUS_INCLUDE_DIR AND ARTOOLKITPLUS_LIBRARIES)
  ...
  if (WIN32)
    ...
    FIND_PATH(ARTOOLKITPLUS_INCLUDE_DIR ARToolKitPlus/ARToolKitPlus.h
       ${ARTKPP_DIR}/include
      /usr/include)
# message(STATUS "Found ARTOOLKITPLUS: ${ARTOOLKITPLUS_INCLUDE_DIR}")     
    FIND_LIBRARY(ARTOOLKITPLUS_LIBRARIES NAMES ARToolKitPlus 
      HINTS
      ${ARTKPP_DIR}/lib
      PATHS
      ${ARTKPP_DIR}/lib
      /usr/lib
      /usr/lib64)
# message(STATUS "Found ARTOOLKITPLUS: ${ARTKPP_DIR}/lib")    
    if(ARTOOLKITPLUS_INCLUDE_DIR AND ARTOOLKITPLUS_LIBRARIES)
      set(ARTOOLKITPLUS_FOUND TRUE)
